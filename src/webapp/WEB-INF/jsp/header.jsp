			...
			<div class="row top-content-info">
				<div class="col-lg-6 top-content-left">
					<ul class="header-info-w3ls">
						...
						<li><i class="fas fa-phone"></i> <a href="tel:+02223688199">+0222
								3688 199</a></li>
						<li><i class="far fa-clock"></i> Mon – Fri : 9:00 -17:00</li>
					</ul>
				</div>
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav mr-lg-auto text-left">
								...
								<li class="nav-item active"><a class="nav-link"
									href="event.htm">Events</a></li>
								<li class="nav-item active"><a class="nav-link"
									href="product.htm">products</a></li>
